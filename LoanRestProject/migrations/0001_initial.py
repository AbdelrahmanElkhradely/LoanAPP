    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('PROVIDER', 'Provider'), ('CUSTOMER', 'Customer'), ('PERSONNEL', 'Personnel')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LoanID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LoanRestProject.outboundloan')),
            ],
        ),
        migrations.AddField(
