"""
Django settings for LoanRestProject project.
...
SECRET_KEY = 'django-insecure-q10c+btvjz8(sp2g5u_i6i5^d+o!06$dcfva(w-t9zbp#(=*)!'
...
ROOT_URLCONF = 'LoanRestProject.urls'
...
AUTH_USER_MODEL="LoanRestProject.User"
